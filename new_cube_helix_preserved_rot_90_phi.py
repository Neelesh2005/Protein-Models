...
def rotate_phi_preserve_helix(structure, chain_id, res_num, angle_deg):
    """
...
# structure = PDBParser(QUIET=True).get_structure("helix", r"e:\protein-model\8U1T_correct.pdb")
# struct = rotate_phi_preserve_helix(structure, "A", 22, 90)
# io = PDBIO()
# io.set_structure(struct)
# output_file = f"helix_rotated_phi_{22}_{90}deg.pdb"
# io.save(output_file)
# logging.info(f"Saved rotated structure to {output_file}")